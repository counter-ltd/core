    ...
    <div class="foot">
      {#if user}
        ...
        <div class="me-actions">
          ...
          <a class="btn btn-icon" href="/settings" aria-label="Settings">
          ...
          <form method="POST" action="/actions/logout">
            <button class="btn btn-icon" type="submit" aria-label="Log out">
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
...
<style>
  ...
  /* Equal padding all sides = square at the same height as any other .btn. */
  .btn-icon {
    justify-content: center;
    padding: var(--space-2);
    flex-shrink: 0;
  }
  /* Stretch the form so the logout button fills its natural height. */
  .me-actions form {
    display: flex;
  }
  .me-actions form .btn {
